...
assert(isset($pack['starters']['vocations']['guardian']));
assert($pack['starters']['vocations']['guardian']['equips']['weapon'] === 'dagger');
assert($pack['starters']['vocations']['adventurer']['equips']['weapon'] === 'dagger');
assert($pack['starters']['vocations']['mystic']['equips']['weapon'] === 'light_jo_staff');
assert($pack['starters']['vocations']['scout']['quiver'][0]['id'] === 'simple_arrow');
assert($pack['starters']['vocations']['scout']['quiver'][0]['count'] === 100);
